export const CabeceraData = {
  ...
  titleContentTable: "Introducción. Mejores sillas de oficina relación calidad precio.",
  img: "oficina",
  text: (
    <>
      <p>
...
export const TopData = [
  ...
  },
  {
    ...
    text: (
      <>
        <p>
          De la mano del mismo fabricante que la anterior, Songmics se mantiene
          en el podio, apostando por una silla gaming con un diseño ergonómico,
          muy parecido a la STMENG LIBERTY T1.
        </p>
        <p>
    ...
    text: (
      <>
        ...
        <p>
          ...
          espumas de alta densidad, <b>añadiendo un cojín lumbar y cervical</b>{" "}
          para conseguir una sensación de comodidad y relajación.
        </p>
        <p>
          ...
          Ha obtenido muy buenas valoraciones y no es para menos, se trata de
          una silla gaming completa, con buenos materiales de construcción y{" "}
